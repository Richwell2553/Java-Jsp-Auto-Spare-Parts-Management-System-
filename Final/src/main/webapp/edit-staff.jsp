      ...
      <div id="content-wrapper">
        <div class="container-fluid">
          ...
          <%
        	...
        	ResultSet rs = st.executeQuery("select * from users where id='"+staffId+"'" );
           ...
           <form action="EditStaff" method="post">
            ...
            <div class="form-group">
              <input
                  ...
                  class="form-control"
                  name="sI"
                  value="<% out.print(rs.getString("id")); %>" />
          ...
          <div class="form-group">
                ...
                <input
                  ...
                  class="form-control"
                  name="sR"
                 value="<% out.print(rs.getString("role")); %>" 
               ...
               <div class="form-group">
                ...
                <input
                  ...
                  class="form-control"
                  name="pW"
                  value="<% out.print(rs.getString("password")); %>" 
